...
addProduct("Derby Hat", "./products/Sunday.png", "Derby Hat", "A beautful hat to wear to the races", "$55.00");
...
addProduct("Ranch Wear", "./products/CowboyHat.png", "Ranch Wear", "Take 'er easy their Pilgram", "$45.00");
addProduct("Couture Chic", "./products/Couture.png", "Couture Chic", "When you have more issues that Vogue", "$59.00");
